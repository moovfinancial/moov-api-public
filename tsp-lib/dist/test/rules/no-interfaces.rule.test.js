import { createLinterRuleTester, createTestRunner, } from "@typespec/compiler/testing";
import { noInterfaceRule } from "../../src/rules/no-interfaces.rule.js";
describe("noInterfaceRule", () => {
    let ruleTester;
    beforeEach(async () => {
        const runner = await createTestRunner();
        ruleTester = createLinterRuleTester(runner, noInterfaceRule, "@moovfinancial/tsp-lib");
    });
    describe("models", () => {
        it("emit diagnostics if using interfaces", async () => {
            await ruleTester.expect(`interface Test {}`).toEmitDiagnostics({
                code: "@moovfinancial/tsp-lib/no-interface",
...
//# sourceMappingURL=no-interfaces.rule.test.js.map